...
void loop() { // <-- 프로그램 시작 하고 매번 이 기능을 수행함
  ...
  lcd.print("DHT Humidity!");  // "" 문장을 출력합니다.
  lcd.setCursor(0, 1);            // lcd의 0,1을 지정합니다.
  lcd.print("Humidity:");         // "Humidity" 라는 문장을 출력합니다.
  lcd.setCursor(10, 1);           // lcd의 10,1을 지정합니다.
  lcd.print(h);                   // h의 값(습도값)을 출력합니다.
  lcd.setCursor(15, 1);           // lcd의 15,1을0지정합니다.
